...
namespace ResourcesWebApplication.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Level,CreatedAT")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Level,CreatedAT")] Language language)
        {
            if (id != language.Id)
            {
                return NotFound();
